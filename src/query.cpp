...
table::rows string_match(table& t, const string& col_name,
                         const string& query_value,
...
table::rows integer_match(table& t, const string& col_name, int query_value,
                          table::opt_rows rows_to_query) {
    table::rows targets = rows_to_query ? *rows_to_query : t.rows_;
    auto targets_vw = views::all(targets);
...
table::rows integer_match(table& t, const string& col_name,
                          const string& query_value,
                          table::opt_rows rows_to_query) {
    table::rows targets = rows_to_query ? *rows_to_query : t.rows_;
    auto targets_vw = views::all(targets);
...
table::rows boolean_match(table& t, const string& col_name, bool query_value,
                          table::opt_rows rows_to_query) {
    table::rows targets = rows_to_query ? *rows_to_query : t.rows_;
    auto targets_vw = views::all(targets);
...
table::rows boolean_match(table& t, const string& col_name,
                          const string& query_value,
                          table::opt_rows rows_to_query) {
    table::rows targets = rows_to_query ? *rows_to_query : t.rows_;
...
table::rows floating_match(table& t, const string& col_name, float query_value,
                           table::opt_rows rows_to_query) {
    table::rows targets = rows_to_query ? *rows_to_query : t.rows_;
    auto targets_vw = views::all(targets);
...
table::rows floating_match(table& t, const string& col_name,
                           const string& query_value,
                           table::opt_rows rows_to_query) {
    table::rows targets = rows_to_query ? *rows_to_query : t.rows_;
...
table::rows geo_query_match(table& t, const string& col_name,
                            const coordinate& coord,
                            table::opt_rows rows_to_query) {
    table::rows targets = rows_to_query ? *rows_to_query : t.rows_;
    auto targets_vw = views::all(targets);
